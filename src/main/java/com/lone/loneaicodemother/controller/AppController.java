...
import com.lone.loneaicodemother.common.DeleteRequest;
import com.lone.loneaicodemother.common.ResultUtils;
import com.lone.loneaicodemother.constant.AppConstant;
import com.lone.loneaicodemother.constant.UserConstant;
...
import com.lone.loneaicodemother.model.dto.app.AppAdminUpdateRequest;
import com.lone.loneaicodemother.model.dto.app.AppQueryRequest;
import com.lone.loneaicodemother.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    /**
     * 应用聊天生成代码（流式 SSE） 解决空格丢失问题以及主动告诉前端生成完成
     *
     * @param appId   应用 ID
     * @param message 用户消息
     * @param request 请求对象
